...
| Historical delivery | D | R2 ownership, tested export/index contracts and R2 adapter, separate production/preview binding configuration, credential scope, and provisioning procedure are defined | no preview object has been uploaded and no deployed historical route reads the binding |

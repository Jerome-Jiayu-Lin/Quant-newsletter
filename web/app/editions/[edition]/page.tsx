...
export default async function HistoricalEditionPage({ params }: PageProps) {
  ...
  try {
    ...
    if (error instanceof EditionUnavailableError) return <EditionUnavailablePage edition={edition} locale="zh" />;
    throw error;
  }
  return <HomePage editionDate={edition} initialDataset={dataset} locale="zh" />;
}

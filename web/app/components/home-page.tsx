...
export default async function HomePage({ locale }: { locale: Locale }) {
  ...
  return (
    <main className="site-shell" lang={t.htmlLang}>
      ...
      <section className="feed-section" id="signals"><div className="section-intro"><p className="tech-label"><span>02</span> CURATED INDEX</p><div><h2>{t.indexTitle}</h2><p>{t.indexDescription}</p></div></div><CardFeed cards={dataset.cards} locale={locale} /></section>
